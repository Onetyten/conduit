  ...
  return (
    <div className='w-full flex justify-center '>
        ...
        <div className='overflow-hidden rounded-2xl w-full aspect-video'>
            ...
            <div className='min-w-32 h-32 rounded-2xl overflow-hidden flex flex-col justify-between p-2 items-center bg-background absolute -right-12 top-1/2 -translate-y-1/2 shadow-md'>
